// Binary serach of a sorted array
#include <stdio.h>
#define SIZE 15
...
// function main fegins program execution
int main(void) {
...
int binarySearch(const int b[], int key, size_t low, size_t high) {
    ...
    while (low <= high) {
        ...
        // display subarray userd int htis loop iteration
        ...
        if (key == b[middle]) {
            ...
            high = middle - 1; // net iteration searches low end of array
        }
...
// part of the array begin processed.
void printRow(const int b[], size_t low, size_t mid, size_t high) {
