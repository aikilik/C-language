...
int main(void) {
    // place the suervey responses in the respnses array
    ...
    // responses and user that value as a subscript into the array
    // frquency to determine the element to increment
